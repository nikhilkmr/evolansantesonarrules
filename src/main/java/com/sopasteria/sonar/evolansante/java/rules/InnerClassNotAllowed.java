...
@Rule(key = "InnerClassNotAllowed", name = "Use of inner class is prohoboted.", description = "Oh! boy, dont you know that use of inner class is prohibited in this project.if you are not sure how to avoid it then, talk to the smart guy of your team.", priority = Priority.CRITICAL, tags = {
"bug" })
